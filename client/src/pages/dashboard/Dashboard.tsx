      ...
      <section className="py-10 md:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto">
          <div className="overview grid">
            <div className="bg-neutral-100 text-dark border border-neutral-400 rounded-md px-4 py-5 totalA">
              <DashboardValue value={applicationStats.totalApplications} label="Total Applications" />
            </div>
            <div className="bg-neutral-100 text-dark border border-neutral-400 rounded-md px-4 py-5 pendingA">
              <DashboardValue value={applicationStats.pendingApplications} label="Pending Applications" />
            </div>
            <div className="bg-neutral-100 text-dark border border-neutral-400 rounded-md px-4 py-5 totalS">
              <DashboardValue value={totalServices} label="Total Services" />
            </div>
            <div className="bg-positive-300 text-light border border-positive-400 rounded-md px-4 py-5 approvedA">
              <DashboardValue value={applicationStats.approvedApplications} label="Approved Applications" />
            </div>
            <div className="bg-negative-300 text-light border border-negative-400 rounded-md px-4 py-5 rejectedA">
          ...
          <div className="grid mt-5 gap-5 grid-cols-1 md:grid-cols-2">
            <div className="w-full bg-gray-100 border border-primary rounded-md px-4 py-5">
            ...
            <div className="w-full bg-gray-100 border border-primary rounded-md px-4 py-5 flex flex-col items-end gap-4">
