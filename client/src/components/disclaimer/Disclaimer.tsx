...
const Disclaimer = () => {
    ...
    return (
        disclaimer ? (
            <div className='fixed bottom-0 left-0 right-0 bg-dark text-light-100 py-4 px-6 z-50'>
                <div className='max-w-dsktp mx-auto flex flex-col lg:justify-between lg:flex-row lg:items-center gap-4 lg:gap-8'>
                    <p className='text-center lg:text-left font-work text-sm leading-relaxed'>
