...
const ServiceForm = () => {
    ...
    return (
        <div>
            <button className='w-14 h-14 fixed bottom-10 right-5 bg-primary shadow-md text-light-100 text-lg grid place-items-center rounded-full ease-bounce duration-200 active:scale-95' onClick={() => setIsModalOpen(true)} color='color'>
                <GrChapterAdd/>
            </button>
